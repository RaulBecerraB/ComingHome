...
video = moviepy.editor.VideoFileClip("intro_ComingHome_2.mov")
...
# video_path = 'intro_ComingHome_1.mp4'  # Cambia esto a la ruta de tu video
...
#     else:
#         video_running = False  # Termina el bucle si no hay más frames

#     pygame.display.flip()

# # Aquí empieza la lógica de tu juego después del video
