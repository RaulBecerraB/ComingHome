...
import random
import time
import games.TicTacToe.TicTacToe as TicTacToeModule
import sixth_stage
from PIL import Image


def fiveth_stage_main():
    ...
    image = pygame.image.load('Escenario5_PIXEL.png')  # Asegúrate de que la imagen tenga 720x3600
    ...
    def photo():
        ...
        frames = extract_frames('imgs/interactingGalaxies.gif')
    ...
    while running:
        ...
        if move_after_game:
            if scroll_x < image_rect.width - screen_width:
                ...
                pygame.mixer.music.load('Sounds/05.mp3')
