...
import random
import time
import games.Crystals.test as CristalModule
from PIL import Image
import fourth_stage


def third_stage_main():
    ...
    image = pygame.image.load('Escenario3_PIXEL.png')  # Asegúrate de que la imagen tenga 720x3600
    ...
    def photo():
        ...
        frames = extract_frames('imgs/PlanetaryNebula.gif')
        ...
        # Salir de Pygame
        fourth_stage.fourth_stage_main()
        pygame.quit()
        sys.exit()
    ...
    while running:
        ...
        if game_running and current_scene == 3:
            ...
            cristal_game = CristalModule.HexPuzzleGame(background_image_path="fondo3FRAME.png", image_size=(720, 720))
            cristal_game.run()
