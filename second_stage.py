...
import random
import time
import games.ConnectionWire.connection as CableConnectionModule
from PIL import Image
import third_stage


def second_stage_main():
    ...
    image = pygame.image.load('Escenario2_PIXEL.png')  # Asegúrate de que la imagen tenga 720x3600
    ...
    def photo():
        ...
        frames = extract_frames('imgs/starFormingRegion_CarinaNebula.gif')
    ...
    while running:
        ...
        if game_running and current_scene == 3:
            ...
            wired_game = CableConnectionModule.CableConnectionGame()
            wired_game.run()
