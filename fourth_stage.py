...
import random
import time
import games.AsteroidDestroyer.AsteroidDestroyer as AsteroidModule
from PIL import Image
import fifth_stage


def fourth_stage_main():
    ...
    image = pygame.image.load('Escenario4_PIXEL.png')  # Asegúrate de que la imagen tenga 720x3600
    ...
    def photo():
        ...
        frames = extract_frames('imgs/interactivGalactiveGroup.gif')
    ...
    while running:
        ...
        if game_running and current_scene == 3:
            ...
            AsteroidModule.asteroid_destroyer()
