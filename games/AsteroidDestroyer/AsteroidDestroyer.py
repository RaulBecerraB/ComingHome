...
def asteroid_destroyer():
    ...
    class Asteroid(pygame.sprite.Sprite):
        def __init__(self):
            ...
            self.image = pygame.transform.scale(self.original_image, (75, 75))  # Redimensionar la imagen del asteroide
    ...
    fixed_positions_x = [165, 245, 325, 405, 485]  # Posiciones fijas en x para los asteroides
